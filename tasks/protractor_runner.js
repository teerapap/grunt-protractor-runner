...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('protractor', 'A grunt task to run protractor.', function() {
    ...
    var strArgs = ["seleniumAddress", "seleniumServerJar", "seleniumPort", "baseUrl", "rootElement", "browser", "chromeDriver", "chromeOnly", "sauceUser", "sauceKey", "sauceSeleniumAddress", "framework", "suite"];
